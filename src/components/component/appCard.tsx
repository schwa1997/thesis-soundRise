...
export const ProjectCard: FC<ProjectCardProps> = ({
  ...
  return (
    <div className="md:w-3/4 w-full text-orange-500 dark:text-white rounded-3xl">
      <div className="bg-orange-200 dark:bg-gray-800 w-full block shadow-2xl rounded-3xl">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <div className="relative h-fit">
            <div className="absolute w-full h-20 top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2 transitiona-all duration-1000 opacity-70 -inset-px bg-gradient-to-r from-orange-500 via-red-200 to-orange-400 rounded-xl blur-lg group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt "></div>
            <a
              href={link}
          ...
          <div className="p-6 min-h-min">
            <h2 className="font-bold mb-2 text-2xl text-orange-800">{title}</h2>
